 ...
 */
    ...
    public:
         ...
         *
         */
        SimpleForecast(std::time_t timestamp, float morningTemp, float dayTemp, float eveningTemp, Weather weather,
                       float precipitation);
    ...
    private:
        ...
        Weather weather;         ///< Погодное явление (солнечно, облачно, дождь, снег, ветрено, туман)
